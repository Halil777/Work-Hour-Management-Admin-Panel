...
const translations: Record<Lang, Record<string, string>> = {
    ru: {
      appTitle: "Система управления рабочим временем",
    ...
    statsTodayFeedbacks: "Сегодняшние отзывы",
      ...
      loginButton: "Войти",
      loginInvalid: "Неверные учетные данные",
    },
    en: {
      appTitle: "Work Hours Management System",
    menuDashboard: "Dashboard",
    menuUsers: "Users",
    menuFeedbacks: "Feedbacks",
    ...
    tr: {
      appTitle: "Çalışma Saatleri Yönetim Sistemi",
      ...
      loginRole: "Rol",
      loginLogin: "Kullanıcı Adı",
      loginPassword: "Şifre",
      loginButton: "Giriş",
      loginInvalid: "Geçersiz bilgiler",
    },
    tm: {
      appTitle: "Iş Sagatlaryny Dolandyryş Ulgamy",
      ...
      menuDisconnect: "Arabaglanyşygy kes",
      searchPlaceholder: "Gözleg...",
      usersTitle: "Ulanyjylar",
      usersId: "ID",
      usersName: "Ady",
      usersPosition: "Wezipesi",
      usersStatus: "Statusy",
      usersTelegram: "Telegram",
      usersCreatedAt: "Döredilen wagty",
      usersLinked: "Baglanyşykly",
      usersUnlinked: "Baglanyşyksyz",
      usersUpdating: "Täzelenýär...",
      workerHoursTitle: "Iş sagatlary",
      workerHoursRecords: "{{count}} ýazgy",
      workerHoursUser: "Ulanyjy",
      workerHoursPosition: "Wezipesi",
      workerHoursDate: "Sene",
      workerHoursHours: "Sagat",
      disconnectTitle: "Telegramy aýyrmak",
      disconnectTelegramId: "Telegram ID",
      disconnectRequired: "Telegram ID hökmany",
      disconnectButton: "Aýyrmak",
      disconnectFailed: "Telegram ID aýrylyp bilinmedi",
      uploadsDateLabel: "Senäni saýla",
      uploadsDrag: "Excel faýlyny sürükle ýa-da saýlamak üçin bas",
      uploadsDrop: "Faýly şu ýere goýberiň...",
      uploadsSupport: "Diňe .xlsx we .xls goldanylýar",
      uploadsRemoveFile: "Faýl aýryldy",
      uploadsCancel: "Ýükleme ýatyryldy ❌",
      ...
      copied: "Göçürildi",
      feedbacksShown: "{{count}} nädogry wagtly habar görkezilýär",
      feedbacksUser: "Ulanyjy",
      feedbacksPosition: "Wezipesi",
      feedbacksTelegram: "Telegram",
      ...
      hoursShort: "sag.",
      searchByName: "Ady boýunça gözleg",
      filterByDate: "Senä görä süz",
      reset: "Arassala",
      statsTotalUsers: "Jemi ulanyjy",
      statsLinkedUsers: "Baglanyşykly ulanyjylar",
      statsUnlinkedUsers: "Baglanyşyksyz ulanyjylar",
      statsTodayFeedbacks: "Şu günki teswirler",
      chartUsersLinked: "Baglanyşykly vs baglanyşyksyz ulanyjylar",
      roleAdmin: "Admin",
      roleSuperAdmin: "Super Admin",
      roleManager: "Menecer",
      loginTitle: "Içeri gir",
      loginRole: "Roly",
      loginLogin: "Ulanyjy ady",
      loginPassword: "Parol",
      loginButton: "Giriş",
      loginInvalid: "Nädogry maglumatlar",
    },
};
